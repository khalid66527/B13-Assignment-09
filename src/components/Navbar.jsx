                    ...
                    {user ? (
                        ...
                        <div className="flex gap-3">
                            <Link href="/auth/signin">
                                <button className="px-4 py-2 rounded-xl border-2 border-green-600 text-green-700 font-semibold hover:bg-green-600 hover:text-white transition-all duration-300 active:scale-95 shadow-sm hover:shadow-md">
                                    Sign In
                                </button>
                            ...
                            <Link href="/auth/signup">
                                <button className="px-4 py-2 rounded-xl bg-gradient-to-r from-green-600 to-green-500 text-white font-semibold shadow-md hover:shadow-lg hover:from-green-700 hover:to-green-600 transition-all duration-300 active:scale-95">
                                    Sign Up
                                </button>
